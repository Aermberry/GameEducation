class EasyQuestionRepository {
	...
	public getAll(): Question[]
	{
		return [
			...
			new Question('____  am eating a banana . ','I',['I','Down','Where']),
			...
			new Question('Dad ____ home at six o’clock yesterday.','came',['came','that','black']),
			...
			new Question('____ mouse has big ears.','That',['That','Of','Put']),
