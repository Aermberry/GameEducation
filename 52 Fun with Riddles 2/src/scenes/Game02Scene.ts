class Game02Scene extends eui.Component implements  eui.UIComponent,GameView {
	...
	protected childrenCreated():void
	{
		...
		this.initDrag();
		this.nextButton.addEventListener(egret.TouchEvent.TOUCH_TAP,()=>this.gotoNextScene(new Game03Scene()),this);
	}
