class Game04Scene extends eui.Component implements  eui.UIComponent {
	...
	protected childrenCreated():void
	{
		...
		this.initDrag();
		this.nextButton.addEventListener(egret.TouchEvent.TOUCH_TAP, () => this.gotoNextScene(new ResultScene()), this);
	}
