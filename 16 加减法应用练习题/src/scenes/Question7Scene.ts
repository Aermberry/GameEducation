class Question7Scene extends eui.Component implements  eui.UIComponent {
	...
	private cakeshopTweenGroup: egret.tween.TweenGroup;
	...
	private async playGame(): Promise<void> {
		this. cakeshopTweenGroup.play(0);
		await lzlib.SoundUtility.playSound("sound7_streamsound 0_mp3")

		this.textRunnersLabel.alpha = 1;
		this. beeTweenGroup.play(0);
		await lzlib.SoundUtility.playSound("sound7_streamsound 1_mp3")
		this.nextStepButton.visible = true;
		this.expressionLabel.visible = true;
	}
	private async playExamples():Promise<void> {
		if(this.expression == "850+110" || this.expression == "110+850"){
