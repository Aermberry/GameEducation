class NextQuestion extends eui.Component implements eui.UIComponent {

	private NextQuestionButtom: eui.Image;
	public constructor() {
		super();
	}
	...
	protected childrenCreated(): void {
		...
		mouse.setButtonMode(this.NextQuestionButtom, true);
