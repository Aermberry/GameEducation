class Plus175And168Scene extends eui.Component implements  eui.UIComponent {
	...
	{
		await this.playTweenGroupAndSound(null, 'add4_streamsound 0_mp3');
		await this.playTweenGroupAndSound(this.tg0, 'add4_streamsound 1_mp3');
		await this.playTweenGroupAndSound(this.tg1, 'add4_streamsound 2_mp3');
		await this.playTweenGroupAndSound(null, 'add4_streamsound 3_mp3');
		await this.playTweenGroupAndSound(this.tg2, 'add4_streamsound 4_mp3');
		await this.playTweenGroupAndSound(this.tg3, 'add4_streamsound 5_mp3');
		await this.playTweenGroupAndSound(this.tg4, 'add4_streamsound 6_mp3');
