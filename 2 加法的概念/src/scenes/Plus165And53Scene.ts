class Plus165And53Scene extends eui.Component implements  eui.UIComponent {
	...
	{
		await this.playTweenGroupAndSound(this.tg0, 'add3_streamsound_0_mp3');
		await this.playTweenGroupAndSound(this.tg1, 'add3_streamsound_1_mp3');
		await this.playTweenGroupAndSound(null, 'add3_streamsound_2_mp3');
		await this.playTweenGroupAndSound(null, 'add3_streamsound_3_mp3');
		await this.playTweenGroupAndSound(null, 'add3_streamsound_4_mp3');
		await this.playTweenGroupAndSound(this.tg2, 'add3_streamsound_5_mp3');
		await this.playTweenGroupAndSound(this.tg3, 'add3_streamsound_6_mp3');
		await this.playTweenGroupAndSound(this.tg4, 'add3_streamsound_7_mp3');
		await this.playTweenGroupAndSound(this.tg5, 'add3_streamsound_8_mp3');
		await this.playTweenGroupAndSound(this.tg6, 'add3_streamsound_9_mp3');
		await this.playTweenGroupAndSound(null, 'add3_streamsound_10_mp3');
		await this.playTweenGroupAndSound(this.tg7, 'add3_streamsound_11_mp3');
		await this.playTweenGroupAndSound(null, 'add3_streamsound_12_mp3');
		await this.playTweenGroupAndSound(null, 'add3_streamsound_13_mp3');
		await this.playTweenGroupAndSound(this.tg8, 'add3_streamsound_14_mp3');
		await this.playTweenGroupAndSound(this.tg9, 'add3_streamsound_15_mp3');
		await this.playTweenGroupAndSound(this.tg10, 'add3_streamsound_16_mp3');
		await this.playTweenGroupAndSound(this.tg11, 'add3_streamsound_17_mp3');
		await this.playTweenGroupAndSound(this.tg12, 'add3_streamsound_18_mp3');
		this.tg13.play();
		this.pauseButton.enabled = false;
		await ThreadUtility.sleep(1000);
		this.pauseButton.enabled = true;
		await this.playTweenGroupAndSound(this.tg14, 'add3_streamsound_19_mp3');
		await this.playTweenGroupAndSound(null, 'add3_streamsound_20_mp3');
		await this.playTweenGroupAndSound(this.tg15, 'add3_streamsound_21_mp3');
		await this.playTweenGroupAndSound(null, 'add3_streamsound_22_mp3');
		await this.playTweenGroupAndSound(null, 'add3_streamsound_23_mp3');
		await this.playTweenGroupAndSound(this.tg16, 'add3_streamsound_24_mp3');
		await this.playTweenGroupAndSound(this.tg17, 'add3_streamsound_25_mp3');
		await this.playTweenGroupAndSound(null, 'add3_streamsound_26_mp3');
		await this.playTweenGroupAndSound(null, 'add3_streamsound_27_mp3');
		await this.playTweenGroupAndSound(null, 'add3_streamsound_28_mp3');
		await this.playTweenGroupAndSound(this.tg18, 'add3_streamsound_29_mp3');
