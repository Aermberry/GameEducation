class Plus165And53Scene extends eui.Component implements  eui.UIComponent {
	...
	{
		await this.playTweenGroupAndSound(this.tg0, 'add3_streamsound 0_mp3');
		await this.playTweenGroupAndSound(this.tg1, 'add3_streamsound 1_mp3');
		await this.playTweenGroupAndSound(null, 'add3_streamsound 2_mp3');
		await this.playTweenGroupAndSound(null, 'add3_streamsound 3_mp3');
		await this.playTweenGroupAndSound(null, 'add3_streamsound 4_mp3');
		await this.playTweenGroupAndSound(this.tg2, 'add3_streamsound 5_mp3');
		await this.playTweenGroupAndSound(this.tg3, 'add3_streamsound 6_mp3');
		await this.playTweenGroupAndSound(this.tg4, 'add3_streamsound 7_mp3');
		await this.playTweenGroupAndSound(this.tg5, 'add3_streamsound 8_mp3');
		await this.playTweenGroupAndSound(this.tg6, 'add3_streamsound 9_mp3');
		await this.playTweenGroupAndSound(null, 'add3_streamsound 10_mp3');
		await this.playTweenGroupAndSound(this.tg7, 'add3_streamsound 11_mp3');
		await this.playTweenGroupAndSound(null, 'add3_streamsound 12_mp3');
		await this.playTweenGroupAndSound(null, 'add3_streamsound 13_mp3');
		await this.playTweenGroupAndSound(this.tg8, 'add3_streamsound 14_mp3');
		await this.playTweenGroupAndSound(this.tg9, 'add3_streamsound 15_mp3');
		await this.playTweenGroupAndSound(this.tg10, 'add3_streamsound 16_mp3');
		await this.playTweenGroupAndSound(this.tg11, 'add3_streamsound 17_mp3');
		await this.playTweenGroupAndSound(this.tg12, 'add3_streamsound 18_mp3');
		this.tg13.play();
		this.pauseLabel.touchEnabled = false;
		this.pauseRect.touchEnabled = false;
		await ThreadUtility.sleep(1000);
		this.pauseLabel.touchEnabled = true;
		this.pauseRect.touchEnabled = true;
		await this.playTweenGroupAndSound(this.tg14, 'add3_streamsound 19_mp3');
		await this.playTweenGroupAndSound(null, 'add3_streamsound 20_mp3');
		await this.playTweenGroupAndSound(this.tg15, 'add3_streamsound 21_mp3');
		await this.playTweenGroupAndSound(null, 'add3_streamsound 22_mp3');
		await this.playTweenGroupAndSound(null, 'add3_streamsound 23_mp3');
		await this.playTweenGroupAndSound(this.tg16, 'add3_streamsound 24_mp3');
		await this.playTweenGroupAndSound(this.tg17, 'add3_streamsound 25_mp3');
		await this.playTweenGroupAndSound(null, 'add3_streamsound 26_mp3');
		await this.playTweenGroupAndSound(null, 'add3_streamsound 27_mp3');
		await this.playTweenGroupAndSound(null, 'add3_streamsound 28_mp3');
		await this.playTweenGroupAndSound(this.tg18, 'add3_streamsound 29_mp3');
	}
