class Question5Scene extends eui.Component implements  eui.UIComponent {
	...
	private eggnumberTweenGroup: egret.tween.TweenGroup;
	...
	private async playGame(): Promise<void> {
		this. eggnumberTweenGroup.play(0);
		await lzlib.SoundUtility.playSound("sound5_streamsound 0_mp3")
	...
	private async playExamples():Promise<void> {
		if(this.expression == "548+352" || this.expression == "352+548"){
