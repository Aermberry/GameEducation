class Question3Scene extends eui.Component implements  eui.UIComponent {
	...
	protected childrenCreated(): void
	{
		...
		(RES.getRes('sound 7 (comic2_s3.mp3)_mp3') as egret.Sound)
		.play(0, 1)
	...
	private onTopSpeakerButtonClick(e: egret.TouchEvent): void
	{
		...
		this.currentSoundChannel = (RES.getRes('sound 69_mp3') as egret.Sound).play(0, 1)
	...
	{
		this.stopCurrentSoundChannel();
		this.currentSoundChannel = (RES.getRes('sound 67_mp3') as egret.Sound).play(0, 1)
	...
	private onBottomAnswerCheckboxClick(e: egret.TouchEvent): void
	{
		...
		if (this.bottomAnswerCheckbox.selected) {
			this.currentSoundChannel = (RES.getRes('sound 3 (comic2_w3.mp3)_mp3') as egret.Sound)
			.play(0, 1);
		}
	}
