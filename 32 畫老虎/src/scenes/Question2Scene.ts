class Question2Scene extends eui.Component implements  eui.UIComponent {
	...
	protected childrenCreated(): void
	{
		...
		(RES.getRes('sound 8 (comic3_s2.mp3)_mp3') as egret.Sound)
		.play(0, 1)
	...
	private onTopSpeakerButtonClick(e: egret.TouchEvent): void
	{
		...
		this.currentSoundChannel = (RES.getRes('sound 73_mp3') as egret.Sound).play(0, 1)
	...
	{
		this.stopCurrentSoundChannel();
		this.currentSoundChannel = (RES.getRes('sound 71_mp3') as egret.Sound).play(0, 1)
	...
	private onBottomAnswerCheckboxClick(e: egret.TouchEvent): void
	{
		...
		if (this.bottomAnswerCheckbox.selected) {
			this.currentSoundChannel = (RES.getRes('sound 4 (comic3_w2.mp3)_mp3') as egret.Sound)
			.play(0, 1);
		}
	}
