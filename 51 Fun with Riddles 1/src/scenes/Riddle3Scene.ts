class Riddle3Scene extends eui.Component implements eui.UIComponent {
	...
	private lettersTipsGroup: eui.Group;
	...
	protected childrenCreated(): void {
		...
		this.addshowTipsLabel(this.useTipsGroup, this.useTipsGroup);
		this.addshowTipsLabel(this.letters, this.lettersTipsGroup);
		this.addshowTipsLabel(this.umbrella, this.umbrellaTipsGroup);
		this.isTrue(this.pencil, this.isTrueImage);
	}
	...
	public async showTipsLabel(
		...
		object.visible = true;
		this.preventClick(
			this.lettersTipsGroup,
			this.umbrellaTipsGroup,
			this.isTrueImage,
			this.goodsGroup,
